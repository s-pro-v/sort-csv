...
function filterInputTable() {
    ...
    rows.forEach(row => {
        ...
        const inputs = row.querySelectorAll("input.editable-cell");
        let rowText = "";
        inputs.forEach(input => {
            rowText += (input.value || "").toLowerCase() + " ";
        });

        // Also check text content for buttons and other elements
                    ...
                    <div class="panel-content">
                        <div class="data-table-wrapper">
                            <div class="data-table-header">
                                ...
                                <div class="panel-content-data-header-controls">
                                    <input type="text" placeholder="Filter..." id="ib-filter" onkeyup="filterCategoryTable('ib')">
                    ...
                    <div class="panel-content">
                        <div class="data-table-wrapper">
                            <div class="data-table-header">
                                ...
                                <div class="panel-content-data-header-controls">
                                    <input type="text" placeholder="Filter..." id="ob-filter" onkeyup="filterCategoryTable('ob')">
                    ...
                    <div class="panel-content">
                        <div class="data-table-wrapper">
                            <div class="data-table-header">
                                ...
                                <div class="panel-content-data-header-controls">
                                    <input type="text" placeholder="Filter..." id="atseu-filter" onkeyup="filterCategoryTable('atseu')">
                    ...
                    <div class="panel-content">
                        <div class="data-table-wrapper">
                            <div class="data-table-header">
                                ...
                                <div class="panel-content-data-header-controls">
                                    <input type="text" placeholder="Filter..." id="other-filter" onkeyup="filterCategoryTable('other')">
    ...
    try {
        ...
        if (modal) {
            modal.addEventListener("click", function (e) {
                // Close if clicking directly on the overlay background (not on modal-container or its children)
                const modalContainer = this.querySelector('.modal-container');
                if (e.target === this || (modalContainer && !modalContainer.contains(e.target))) {
                    closeModal();
                }
            });
